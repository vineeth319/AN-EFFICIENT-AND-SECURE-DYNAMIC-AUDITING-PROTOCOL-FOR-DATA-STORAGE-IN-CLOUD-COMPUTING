      ...
      <div class="column2">
       ...
       try{
          ...
          Statement st1=con.createStatement();
           ...
           ResultSet rs=st.executeQuery("select * from tpareq where tpaperm!='waiting'");
           while(rs.next()){
             ...
             <tr>
                 ...
                 <td><%=size%></td>
                 <td><%=date%></td>
                 <td><a href="Downd.jsp?fid=<%=fid%>&filename=<%=filename1%>"><input type="button" value="Download"></input></a></td>
             </tr>
                   <% } 
         }catch(Exception e){
           out.println(e);
